# Optional Game Content for Swords & Wizardry

> Compatible with the Swords & Wizardry rules

![Foundry v14](https://img.shields.io/badge/foundry-v14-green)

This module contains copyrighted content (Product Identity) from Mythmere Games' [Swords & Wizardry Book of Options](https://www.mythmeregames.com/products/swords-wizardry-book-of-options) for use with [Swords & Wizardry game system](https://foundryvtt.com/packages/swords-wizardry) for Foundry. This content is released under a verbal agreement with Mythmere Games. You will need a copy of the Book of Options to make use of this content.
